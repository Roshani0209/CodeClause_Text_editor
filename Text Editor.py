...
class Text_Editor():
    def __init__(self, App):
        ...
        self.App.geometry("600x950+300+5")
        self.App.resizable=True
        self.Fnt_CourierNew = "Courier New" 
        ...
        B_Menu_Open.place(x=000, y=20)
        B_Menu_New = Tk.Button(self.App, text="New", width=16, bg='blue', fg='white', borderwidth=0, command=self.F_Menu_New)
        B_Menu_New.place(x=120, y=20)
        B_Menu_Save = Tk.Button(self.App, text="Save", width=16, bg='blue', fg='white', borderwidth=0, command=self.F_Menu_Save)
        B_Menu_Save.place(x=240, y=20)
        B_Menu_SaveAs = Tk.Button(self.App, text="Save As", width=16, bg='blue', fg='white', borderwidth=0, command=self.F_Menu_SaveAs)
        B_Menu_SaveAs.place(x=360, y=20)
        B_Menu_About = Tk.Button(self.App, text="About", width=16, bg='blue', fg='white', borderwidth=0, command=self.F_Menu_About)
        B_Menu_About.place(x=480, y=20)
        #Text Box     
        self.T_Write_Area = Tk.Text(self.App, width=73, height=55)
        self.T_Write_Area.place(x=5, y=48)
        #Status
        self.L_Status = Tk.Label(self.App, text="Every Thing Is Good!!")
        self.L_Status.place(x=0, y=932)

        L_Status_Copy = Tk.Label(self.App, text="©RoshaniChaudhari",width=16)
